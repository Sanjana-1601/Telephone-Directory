	...
	case  1:  //responsible for addition of record
	 {
	  ...
	  f.open("rec.dat",ios::in|ios::out|ios::ate|ios::app|ios::binary);
	  char ans;
 ...
 case 3: // search
{
 ...
 char address[20];
 unsigned long long int ph_no;
 f.open("rec.dat",ios::in|ios::binary);
 ...
 break;
       ...
       case 4:  //for the modification
	{
	  ...
	  char ans;
	  fstream f; stud s;
	  char name[20]; char address[20]; unsigned long long int ph_no;
	  f.open("rec.dat",ios::in|ios::binary);
    ...
    case 5:  //responsible for the deletion of the record
       ...
       stud s;
	    ifstream fin;
      fstream fout;
	fin.open("rec.dat",ios::in|ios::binary);
      fout.open("va.dat",ios::out|ios::app|ios::binary);
	 cout<<"\n \t\t\t  DELETING :-";
      int i;
      fflush(stdin);
      cout<<"\n\n      Enter the name  :-  ";
